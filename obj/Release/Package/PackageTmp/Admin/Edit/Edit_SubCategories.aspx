<%@ Page Title="تعديل الفئة الفرعية" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Edit_SubCategories.aspx.cs" Inherits="Shop_College.Admin.Edit.Edit_SubCategories" %>
    ...
    <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
      <div class="d-table-cell align-middle">
        ...
        <div class="text-right mt-4 mr-0 col-9">
          <h2 class=" mb-4 tit" style="font-size:26px">تعديل الفئة الفرعية</h2>
            </div>
        ...
        <ProgressTemplate>
                ...
                <ContentTemplate>
                    ...
                    <%--تعديل عن طريق الفئة الفرعية الواحدة--%>
                ...
                <div class="row register-form">
                      <div class="col-md-12 " >
                          <div class="form-group">
                               <label>الإسم</label>
                              <asp:TextBox ID="txtName" runat="server" class="form-control"  placeholder="قم بإدخال اسم الفئة الفرعية" style="display:inline-block;width:94%" ValidationGroup="vv"></asp:TextBox>
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="اسم الفئة الفرعية مطلوب" Text="*" ValidationGroup="vv" ControlToValidate="txtName" style="color:red;font-size:20px"></asp:RequiredFieldValidator>
                          </div>
     ...
     <asp:textbox id="Message_Box" runat="server" TextMode="MultiLine"  maxlength="255" rows="4" cols="5"  class="form-control" placeholder="قم بإدخال وصف قصير بحد أقصى 255 حرف" wrap="true"  style="display:inline-block;width:94%" ValidationGroup="vv"/>
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="وصف الفئة الفرعية مطلوب" Text="*" ValidationGroup="vv" ControlToValidate="Message_Box" style="color:red;font-size:20px"></asp:RequiredFieldValidator>

</div>
      <!--بداية الدروب داون -->
                            <div class="form-group">
                               <label>فئة الأم</label>


                                <div class="dropdown pmd-dropdown">
                                    <asp:DropDownList ID="drp1" runat="server" class="dropdown pmd-dropdown dropdown-item-text drr form-control" style="display:inline-block;width:60%" aria-expanded="true" DataSourceID="SqlDataSource1" DataTextField="Cate_Name" DataValueField="Cate_Id">

                                    </asp:DropDownList>

                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:const %>" SelectCommand="SELECT [Cate_Name], [Cate_Id] FROM [TbCategories]"></asp:SqlDataSource>
                                           </div>
