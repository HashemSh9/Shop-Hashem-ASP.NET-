<%@ Page Title="تعديل السؤال" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Edit_FAQ.aspx.cs" Inherits="Shop_College.Admin.Edit.Edit_FAQ" %>
    ...
    <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
      <div class="d-table-cell align-middle">
        ...
        <div class="text-right mt-4 mr-0 col-9">
         <h2 class=" mb-4 tit">تعديل الأسئلة الشائعة</h2>
            </div>

              <div class="text-left col-3 mt-4 mr-0">
                  <h2 class=" mb-4 " ><asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-primary shadow" NavigateUrl="~/Admin/List/FAQ.aspx" ><i class="fa fa-angle-double-right text-white"></i> رجوع</asp:HyperLink></h2>     
            </div>
            ...
            <div class="m-sm-4">
                ...
                <div class="row register-form">
                  ...
                  <div class="form-group">
                    ...
                    <asp:textbox id="Message_Box" runat="server" TextMode="MultiLine"  maxlength="400" rows="4" cols="5"  class="form-control" placeholder="قم بإدخال سؤال بحد أقصى 255 حرف" wrap="true"  style="display:inline-block;width:94%" ValidationGroup="vv"/>
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="نص السؤال مطلوب" Text="*" ValidationGroup="vv" ControlToValidate="Message_Box" style="color:red;font-size:20px"></asp:RequiredFieldValidator>
                  ...
                  <div class="form-group">
                    ...
                    <asp:textbox id="Message_Box2" runat="server" TextMode="MultiLine"  maxlength="700" rows="6" cols="8"  class="form-control" placeholder="قم بإدخال الإجابة" wrap="true"  style="display:inline-block;width:94%" ValidationGroup="vv"/>
