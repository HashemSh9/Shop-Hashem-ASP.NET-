<%@ Page Title="إضافة تعليق" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Add_Comments.aspx.cs" Inherits="Shop_College.Admin.Add.Add_Comments" %>
                ...
                <div class="d-table-cell align-middle">
                    ...
                    <div class="row mb-4" style="border-bottom: 1px solid #e2e5f3">
                        ...
                        <div class="text-right mt-4 mr-0 col-9">
                            <h2 class=" mb-4 tit">إضافة تعليق</h2>
                        </div>

                        <div class="text-left col-3 mt-4 mr-0">
                            <h2 class=" mb-4 ">
                                <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-primary shadow" NavigateUrl="~/Admin/List/Comments.aspx"><i class="fa fa-angle-double-right text-white"></i> رجوع</asp:HyperLink></h2>
                        </div>
                                            ...
                                            <div class="row register-form">
                                                <div class="col-md-12 ">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="قم باختيار رقم الإعلان!" Text="*" ValidationGroup="vv" ControlToValidate="ddrads" Style="color: red; font-size: 30px"></asp:RequiredFieldValidator>
                                                        <div class="dropdown pmd-dropdown">
                                                            <asp:DropDownList ID="ddrads" runat="server" class="dropdown pmd-dropdown dropdown-item-text drr form-control" Style="display: inline-block; width: 80%" aria-expanded="true">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="dropdown pmd-dropdown">
                                                            <asp:DropDownList ID="ddrUsers" runat="server" class="dropdown pmd-dropdown dropdown-item-text drr form-control" Style="display: inline-block; width: 80%" aria-expanded="true">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="dropdown pmd-dropdown">
                                                            <asp:DropDownList ID="drp1" runat="server" class="dropdown pmd-dropdown dropdown-item-text drr form-control" Style="display: inline-block; width: 80%" aria-expanded="true">
