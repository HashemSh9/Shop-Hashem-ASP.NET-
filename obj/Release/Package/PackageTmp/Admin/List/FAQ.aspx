<%@ Page Title="الأسئلة الشائعة" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="FAQ.aspx.cs" Inherits="Shop_College.Admin.List.FAQ" %>
...
<script>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <div class="col-6 col-xl-4">
                        <h2><b>إدارة</b> الأسئلة الشائعة</h2>
                    </div>
    ...
    " placeholder="ادخل اسم او رقم" aria-label="Recipient's username" aria-describedby="basic-addon2" ></asp:TextBox></div> 
                        <a href="../Add/Add_FAQ.aspx" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>إضافة سؤال</span></a>
            ...
            <ContentTemplate>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound"  >
                        ...
                        <ItemTemplate>
                                <tr>
                                              <td> <!-- Duc-->
                                              <asp:Label ID="Label1" runat="server" Text='<%# Eval("FAQ_Id") %>'></asp:Label>
                                       
                                          </td>
                                         <td>
                                            <asp:Label ID="ltlQues" runat="server" Text='<%# Eval("FAQ_Question") %>'></asp:Label>
                                        </td>
                                         <td>
                                            <asp:Label ID="ltlAnsse" runat="server" Text='<%# Eval("FAQ_Answer") %>'></asp:Label>
                                        </td>
                                             

                            
                                        <td>
                                            <asp:LinkButton ID="Lnk" runat="server"  CommandArgument='<%# Eval("FAQ_Id") %>' OnClick="Lnk_Click" class="settings" title="تعديل" data-toggle="tooltip" ><i class="material-icons">&#xE8B8;</i></asp:LinkButton>


                                            <asp:LinkButton ID="BtnDel"  runat="server" CommandArgument='<%# Eval("FAQ_Id") %>' 
                                                OnClientClick = "return confirm('هل أنت متأكد من حدف السؤال؟! !.');"
