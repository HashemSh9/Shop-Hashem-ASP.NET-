<%@ Page Title="" Language="C#" MasterPageFile="~/Regst.Master" AutoEventWireup="true" CodeBehind="All_Categories.aspx.cs" Inherits="Shop_College.All_Categories"  enableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="col-12">
    ...
    <h3 class="site-title mb-3" >عرض الفئات</h3>

    <p class="text-secondary">
      اجعل تسوقك أسهل مع خيارات الفئات المتنوعة. 
      استكشف مجموعة واسعة من الفئات للعثور على ما تبحث عنه
      بكل سهولة ويسر. 
    </p>
  ...
  <div class="col-md-12">
    ...
    <div class="input-group mb-3">
     <asp:TextBox ID="txtserc" runat="server" CssClass="form-control mt-1" placeholder="ابحث على فئة .." TextMode="Search"  AutoPostBack="True" style="border-radius:8px" OnTextChanged="txtserc_TextChanged"></asp:TextBox>
 ...
 <asp:Repeater ID="Repeater1" runat="server">
  ...
  <div class="col-12 col-md-6 col-xl-3 cate-card text-center " style="border-radius:7px;margin:5px;">
    <div class="card text-center" style="border-color: #fafaff;">
      ...
      <h5 class="mt-2" style="font-weight:600"><%#  Eval("Cate_Name") %></h5> 
      <p class="text-secondary text-sm-right mt-2" style="font-size: 11px;"><%#  Eval("Cate_Description") %></p>
      <p class="Contsubcat"><%#  Eval("SubCategoriesCount") + " فئة فرعية" %></p>
    </div>
  </div>
