<%@ Page Title="إضافة فئة فرعية" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Add_SubCategories.aspx.cs" Inherits="Shop_College.Admin.Add.Add_SubCategories" %>
    ...
    <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
      <div class="d-table-cell align-middle">
        ...
        <div class="text-right mt-4 mr-0 col-9">
          <h2 class=" mb-4 tit">إضافة فئة فرعية</h2>
            </div>
