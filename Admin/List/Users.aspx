<%@Page Title="المستخدمين" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="Shop_College.Admin.List.Users" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    " placeholder="ادخل اسم او رقم" aria-label="Recipient's username" aria-describedby="basic-addon2" ></asp:TextBox></div> 
                        <a href="../Add/Add_Users.aspx" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span style="font-size:10px">إضافة مستخدم جديد</span></a>
                        ...
                        <ItemTemplate>
                                <tr>
                                         ...
                                         <div class="col-sm-6 col-lg-4 col-xl-4">
                                             <asp:Image ID="Image1" runat="server" ImageUrl='<%# "../../" + Eval("User_Photo") %>' class="avatar" alt="Avatar" />
                                             </div> 
                                        <div class="nam">
                                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("User_FName") %>'></asp:Label>
                                              <asp:Label ID="Label3" runat="server" Text='<%# Eval("User_LName") %>'></asp:Label><br />
                                              <asp:Label ID="Label4" runat="server" Text='<%# Eval("User_Phone") %>' style="color:#8392ab!important"></asp:Label>
                                </div>
                                                       </div>
                                             </td>
                                          <%--<td>
                                         ...
                                         <td>
                                      <asp:Label ID="Label6" runat="server" Text='<%# Eval("User_RegStatu") %>' ></asp:Label>
                                        </td>
                                             <td>
                                      <asp:Label ID="Label7" style="text-align:center" runat="server" Text='<%# Eval("Us_Time", "{0:t:HH:mm}").Substring(0, 5) %>'></asp:Label>
                                     <br /> <asp:Label ID="Label5" runat="server" Text='<%# Eval("Us_Date") %>'></asp:Label>
                                        </td>
                                        <td>
                                      <asp:Label ID="Label9" runat="server" Text='<%# Eval("User_GroupID") %>'></asp:Label>
                                        </td>
                                     <td>
                                      <asp:Label ID="Label8" runat="server" Text='<%# Eval("AdsCount") + " إعلان"%>'></asp:Label>
                                        </td>
                                        <td>
                                            <asp:LinkButton ID="Lnk" runat="server"  CommandArgument='<%# Eval("User_ID") %>' OnClick="Lnk_Click" class="settings" title="تعديل" data-toggle="tooltip" ><i class="material-icons">&#xE8B8;</i></asp:LinkButton>


                                            <asp:LinkButton ID="BtnDel"  runat="server" CommandArgument='<%# Eval("User_ID") %>' 
                                                OnClientClick = "return confirm('هل أنت متأكد من حظر الحساب؟! سوف يتم إيقاف جميع أنشطته في المتجر!.');"
                                                OnClick="BtnDel_Click" class="delete" title="حظر" data-toggle="tooltip"   ><i class="fa fa-ban" style="color:red"></i></asp:LinkButton>
                                        </td>
