<%@ Page Title="التعليقات" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Comments.aspx.cs" Inherits="Shop_College.Admin.List.Comments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    " placeholder="ادخل اسم او رقم" aria-label="Recipient's username" aria-describedby="basic-addon2" ></asp:TextBox></div> 
                               <a href="../Add/Add_Comments.aspx" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span style="">إضافة تعليق</span></a>
            ...
            <ContentTemplate>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server"  OnItemDataBound="Repeater1_ItemDataBound1"   >
                        ...
                        <ItemTemplate>
                                <tr>
                                              <td>
                                              <asp:Label ID="Label1" runat="server" Text='<%# Eval("Com_Id") %>'></asp:Label>
                                             </td>
                                             ...
                                             <asp:Image ID="Image1" runat="server" ImageUrl='<%# "../../" + Eval("User_Photo") %>' class="avatar" alt="Avatar" />
                                                ...
                                                <div class="nam" CssClass="mt-3">
                                                <asp:Label ID="lblfname" runat="server" Text='<%# Eval("User_FName") %>' ></asp:Label>
                                              <asp:Label ID="lbllname" runat="server" Text='<%# Eval("User_LName") %>'></asp:Label><br />
                                              </div>
                                                       </div>
                                                </td>
                                    
                                              <td>
                                              <asp:Label ID="lblcom" runat="server" Text='<%# Eval("Com_Text") %>'></asp:Label>
                                             </td>
                                              <td>
                                              <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("Ads_Title") %>'></asp:Label>
                                               </td>
                                                  <td>
                                              <asp:Label ID="lblcomstatu" runat="server" Text='<%# Eval("Com_Status") %>'></asp:Label>
                                             </td>
                                               <td>
                                     ...
                                     <br /> <asp:Label ID="lbldate" runat="server" Text='<%# Eval("Us_Date") %>'></asp:Label>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="Lnk" runat="server"  CommandArgument='<%# Eval("Com_Id") %>' OnClick="Lnk_Click" class="settings" title="تعديل" data-toggle="tooltip" ><i class="material-icons">&#xE8B8;</i></asp:LinkButton>


                                            <asp:LinkButton ID="BtnDel"  runat="server" CommandArgument='<%# Eval("Com_Id") %>' 
                                                OnClientClick = "return confirm('هل أنت متأكد من حدف التعليق؟! !.');"
