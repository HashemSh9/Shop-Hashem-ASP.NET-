    ...
    public partial class Comments : System.Web.UI.Page
    {
        ...
        ["const"].ToString());
            ...
            {//في حالة لم يقم بعملية بحث يتم عرض بشكل عادي
                string sql = "SELECT c.Com_Id, c.Com_Text, c.Com_Status, CONVERT(varchar, c.Com_Date, 103) AS Us_Date, CONVERT(varchar, c.Com_Date, 108) AS Us_Time, a.Ads_Title, u.User_FName, u.User_LName, u.User_Photo FROM TbComment c INNER JOIN TbAds a ON c.Ads_Id = a.Ads_Id INNER JOIN TbUsers u ON c.User_ID = u.User_ID order by c.Com_Id asc";
        ...
        protected void Lnk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("~/Admin/Edit/Edit_Comments.aspx?id=" + id);
            }
            catch
            {
        ...
        bool DeleteRecord(string id)
        {
            ...
            try
            {
                ...
                {
                    string sql = "delete from TbComment where Com_Id=@id ";
        ...
        protected void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else// في حالة قام بكتابة شيء
                {
                    ...
                    string query = "SELECT c.Com_Id, c.Com_Text, c.Com_Status, CONVERT(varchar, c.Com_Date, 103) AS Us_Date, CONVERT(varchar, c.Com_Date, 108) AS Us_Time, a.Ads_Title, u.User_FName, u.User_LName, u.User_Photo FROM TbComment c INNER JOIN TbAds a ON c.Ads_Id = a.Ads_Id INNER JOIN TbUsers u ON c.User_ID = u.User_ID WHERE c.Com_Id LIKE '%" + @searchTerm + "%' OR u.User_FName LIKE '%" + @searchTerm + "%' OR u.User_LName LIKE '%" + @searchTerm + "%' OR a.Ads_Title LIKE '%" + @searchTerm + "%' OR c.Com_Status LIKE '%" + @searchTerm + "%' ORDER BY c.Com_Id ASC";
               ...
               txtSearch.Focus();
                // وضع النص الحالي في بداية الحقل
        ...
        protected void Exp_Exl(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT c.Com_Id, c.Com_Text, CAST(c.Com_Status AS VARCHAR(1)) AS ComStatus, CONVERT(varchar, c.Com_Date, 103) AS Us_Date, CONVERT(varchar, c.Com_Date, 108) AS Us_Time, a.Ads_Title, u.User_FName, u.User_LName, u.User_Photo FROM TbComment c INNER JOIN TbAds a ON c.Ads_Id = a.Ads_Id INNER JOIN TbUsers u ON c.User_ID = u.User_ID ORDER BY c.Com_Id ASC;";
        ...
        protected void Repeater1_ItemDataBound1(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label comlbl = e.Item.FindControl("lblcom") as Label;
                ...
                if (comlbl.Text.Length >= MaxLength)
                {//في حال تجاوز النص عدد الحروف المحددة
                    comlbl.Text = comlbl.Text.Substring(0, maxLength) + "...";
                }
                ...
                Label lbl = e.Item.FindControl("lblcomstatu") as Label;


                //الحصول علي عنصر حالة التلعيق
