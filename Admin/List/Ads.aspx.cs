    ...
    public partial class Ads : System.Web.UI.Page
    {
        ...
        protected void Lnk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("~/Admin/Edit/Edit_Ads.aspx?id=" + id);
            }
            catch (Exception)
            {
        ...
        //دالة إيقاف الإعلان الإعلان عندالنقر على الزر
        ...
        //دالة لعمل تحديث وإيقاف للإعلان
        bool BanAds(string id)
        {
            try
            {
                // تحديث العنصر وإيقافه     .
                using (SqlConnection con = new SqlConnection(cs))
                {
                    string sql = "UPDATE TbAds SET Ads_Status = 3 WHERE Ads_Id = @ID";
        ...
        {
            //استعلام يتم استخدامه لإستخراج ملف الإكسيل
            //معالجة مشكلة ملف الإكسيل لا يستطيع إخراج حقل من نوع bit
            //تم تغيير نوع الحقل في الإستعلام، لكي يستطيع التعامل معه وقرائته
            string sql = "SELECT a.Ads_Id, a.Ads_Title, a.Ads_Prics, a.Ads_Descrip, a.Ads_Location, a.Ads_Status, (CONVERT(varchar, a.Ads_DateAdded, 103))  AS Us_Date, ( CONVERT(varchar, a.Ads_DateAdded, 108)) AS Us_Time, CAST(a.Ads_ProductStatus AS VARCHAR(1)) AS Ads_ProductStatus, CAST(a.Ads_Sold AS VARCHAR(1)) AS Ads_Sold , s.Subcate_Name AS SubcategoryName, u.User_UserName AS UserName, COUNT(DISTINCT i.Img_Id) AS NumImages, MAX(CASE WHEN i.Img_IsMain = 1 THEN i.Img_Path END) AS MainImage, COUNT(DISTINCT c.Com_Id) AS NumComments FROM TbAds a LEFT JOIN TbAds_Images i ON a.Ads_Id = i.Ads_Id LEFT JOIN TbComment c ON a.Ads_Id = c.Ads_Id LEFT JOIN TbSubcategory s ON a.Subcate_Id = s.Subcate_Id LEFT JOIN TbUsers u ON a.User_ID = u.User_ID GROUP BY a.Ads_Id, a.Ads_Title, a.Ads_Prics, a.Ads_Descrip, a.Ads_Location, a.Ads_Status, a.Ads_DateAdded, a.Ads_ProductStatus, a.Ads_Sold, s.Subcate_Name, u.User_UserName;";
        ...
        protected void Repeater1_ItemDataBound1(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label sold = e.Item.FindControl("lblSold") as Label;
