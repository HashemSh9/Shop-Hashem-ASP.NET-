    ...
    public partial class FAQ : System.Web.UI.Page
    {
        ...
        protected void Lnk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("~/Admin/Edit/Edit_FAQ.aspx?id=" + id);
            }
            catch
            {
        ...
        bool DeleteRecord(string id)
        {
            try
            {
                ...
                {
                    string sql = "delete from TbFAQ where FAQ_Id=@id";
        ...
        protected void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else// في حالة قام بكتابة شيء
                {
                    ...
                    string query = "select * from TbFAQ WHERE FAQ_Id LIKE '%" + @searchTerm + "%' OR FAQ_Question LIKE '%" + @searchTerm + "%' OR FAQ_Answer LIKE '%" + @searchTerm + "%'";
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label TiAque = e.Item.FindControl("ltlQues") as Label;
                TiAque.Style["font-weight"] = "600;";




                //الحصول ع عنصر العنوان للتحكم به داخل اداة الريبيتر
                Label title = e.Item.FindControl("ltlQues") as Label;
                ...
                //الحصول ع عنصر العنوان للتحكم به داخل اداة الريبيتر
                Label Ansse = e.Item.FindControl("ltlAnsse") as Label;
                ...
                if (Ansse.Text.Length >= maxLength2)
                {//في حال تجاوز النص عدد الحروف المحددة
                    Ansse.Text = Ansse.Text.Substring(0, maxLength2) + "...";
                }
